...
from Purchasers_Fee import compute_purchasers_fee
...
def  assert_expected_cc_fee(fee_names, request_json, api_response):
    ...
    fee_functions = {
        ...
        "Club Fee": compute_club_fee,
        "Lenders Title Insurance": compute_lenders_title_insurance_fee,
        ...
        "Purchasers Fee": compute_purchasers_fee,
    }
